...
def main():
    ...
    projects = open('test codes/projectsTEST.csv','r',encoding = "utf8")
    students = open('test codes/studentsTEST.csv','r',encoding = "utf8")
    ...
    with projects as csvDataFile:
        ...
        printContract(studentArray,projectList[9]) 
