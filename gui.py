...
class StartPage(tk.Frame):
    ...
    def student_file_button(self):
        ...
        self.button.grid(column=0, row=2, padx=20, pady=5)
    ...
    def project_file_dialog(self):
        ...
        self.label.grid(column=0, row=5, padx=20, pady=0)
